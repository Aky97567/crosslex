...
export const BADGES: StreakBadge[] = [
...
export const getEarnedBadges = (bestCount: number): StreakBadge[] =>
  BADGES.filter(b => b.days <= bestCount);

export const getNewlyEarnedBadge = (prevBest: number, newCount: number): StreakBadge | undefined =>
