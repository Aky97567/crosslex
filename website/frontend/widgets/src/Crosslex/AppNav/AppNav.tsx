...
const AppNav: React.FC<Props> = ({ onBellClick, onGearClick, onPaletteClick, onBadgesClick }) => (
  <header className="fixed top-0 left-0 right-0 z-20 bg-bg-l2 border-b-2 border-brand">
    <div className="max-w-4xl mx-auto px-20 h-60 flex items-center justify-between">
