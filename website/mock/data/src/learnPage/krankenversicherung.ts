  ...
  content: {
    ...
    modules: [
      ...
      },
      {
        ...
        paragraphWithUsage: [
          'In Deutschland ist die {{Krankenversicherung}} für alle Pflicht.',
          'Meine {{Krankenversicherung}} übernimmt die Kosten für den Arztbesuch.',
          'Ich habe mich bei der AOK als {{Krankenversicherung}} angemeldet.',
        ],
      },
      {
