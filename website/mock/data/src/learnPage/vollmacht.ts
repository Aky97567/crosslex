  ...
  content: {
    ...
    modules: [
      ...
      },
      {
        ...
        paragraphWithUsage: [
          'Ich habe meiner Freundin eine {{Vollmacht}} gegeben, damit sie das Paket für mich abholen kann.',
          'Die {{Vollmacht}} muss schriftlich erteilt werden.',
          'Für manche Behördengänge ist eine notarielle {{Vollmacht}} erforderlich.',
        ],
      },
      {
