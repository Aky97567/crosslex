  ...
  content: {
    ...
    modules: [
      ...
      },
      {
        ...
        paragraphWithUsage: [
          'Mein Vater bezieht seit drei Jahren eine {{Rente}}.',
          'Die {{Rente}} reicht kaum, um alle Lebenshaltungskosten zu decken.',
          'Er hat seinen Antrag auf {{Rente}} rechtzeitig beim zuständigen Amt eingereicht.',
        ],
      },
      {
