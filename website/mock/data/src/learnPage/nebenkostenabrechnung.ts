  ...
  content: {
    ...
    modules: [
      ...
      },
      {
        ...
        paragraphWithUsage: [
          'Ich habe die {{Nebenkostenabrechnung}} von meinem Vermieter bekommen.',
          'Die {{Nebenkostenabrechnung}} zeigt, dass ich 150 Euro nachzahlen muss.',
          'Ich habe die {{Nebenkostenabrechnung}} sorgfältig auf Fehler geprüft.',
        ],
      },
      {
