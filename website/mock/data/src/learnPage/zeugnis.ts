  ...
  content: {
    ...
    modules: [
      ...
      },
      {
        ...
        paragraphWithUsage: [
          'Mein Arbeitgeber hat mir ein gutes {{Zeugnis}} ausgestellt.',
          'Das {{Zeugnis}} beschreibt meine Leistungen und meinen Charakter sehr positiv.',
          'Ohne ein starkes {{Zeugnis}} ist es schwer, eine neue Stelle zu finden.',
        ],
      },
      {
