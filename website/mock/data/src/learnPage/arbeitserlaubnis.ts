  ...
  content: {
    ...
    modules: [
      ...
      },
      {
        ...
        paragraphWithUsage: [
          'Ohne {{Arbeitserlaubnis}} darf ich in Deutschland nicht arbeiten.',
          'Meine {{Arbeitserlaubnis}} ist an meinen aktuellen Arbeitgeber gebunden.',
          'Die Verlängerung der {{Arbeitserlaubnis}} muss rechtzeitig beantragt werden.',
        ],
      },
      {
