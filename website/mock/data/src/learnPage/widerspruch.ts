  ...
  content: {
    ...
    modules: [
      ...
      },
      {
        ...
        paragraphWithUsage: [
          'Ich habe gegen den Bescheid {{Widerspruch}} eingelegt.',
          'Der {{Widerspruch}} muss innerhalb eines Monats eingereicht werden.',
          'Nach dem {{Widerspruch}} prüft die Behörde den Fall erneut.',
        ],
      },
      {
