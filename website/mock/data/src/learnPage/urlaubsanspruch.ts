  ...
  content: {
    ...
    modules: [
      ...
      },
      {
        ...
        paragraphWithUsage: [
          'Mein {{Urlaubsanspruch}} beträgt 28 Tage pro Jahr.',
          'Ich habe meinen {{Urlaubsanspruch}} bis Oktober noch nicht vollständig genutzt.',
          'Der Arbeitgeber muss den gesetzlichen {{Urlaubsanspruch}} gewähren.',
        ],
      },
      {
