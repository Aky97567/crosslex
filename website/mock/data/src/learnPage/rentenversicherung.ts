  ...
  content: {
    ...
    modules: [
      ...
      },
      {
        ...
        paragraphWithUsage: [
          'Mein Arbeitgeber und ich zahlen gemeinsam in die {{Rentenversicherung}} ein.',
          'Die {{Rentenversicherung}} sichert mir im Alter eine monatliche Rente.',
          'Alle Beschäftigten in Deutschland sind Mitglied in der {{Rentenversicherung}}.',
        ],
      },
      {
