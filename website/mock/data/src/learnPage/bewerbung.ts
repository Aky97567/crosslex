  ...
  content: {
    ...
    modules: [
      ...
      },
      {
        ...
        paragraphWithUsage: [
          'Ich habe eine {{Bewerbung}} für die Stelle als Buchhalter abgeschickt.',
          'Die {{Bewerbung}} muss ein Anschreiben und einen Lebenslauf enthalten.',
          'Nach meiner {{Bewerbung}} habe ich eine Woche auf eine Antwort gewartet.',
        ],
      },
      {
